...
window.TableFlowLegacyMenuConfig = {
  ...
  items: [
    ...
    item("decaf-coffee", "DECAF", "Decaf Coffee", "Decaf", "BEV", "Hot Drinks", null, false, null, ["Cream", "Sugar"], 4),

    item("coke", "COKE", "Coke", "Coke", "BEV", "Soft Drinks", null, false, null, ["No ice", "Light ice", "Extra ice", "Lemon", "No lemon"], 10),
    ...
    item("minute-maid-orange-juice", "MM OJ", "Minute Maid Orange Juice", "MM OJ", "BEV", "Juice", null, false, null, ["Small", "Large", "No ice"], 22),
    item("minute-maid-apple-juice", "MM APPLE", "Minute Maid Apple Juice", "MM Apple", "BEV", "Juice", null, false, null, ["Small", "Large", "No ice"], 23),
    item("milk", "MILK", "Milk", "Milk", "BEV", "Milk", null, false, null, ["2%", "White", "Small", "Large"], 24),
    item("chocolate-milk", "CHOC MILK", "Chocolate Milk", "Choc Milk", "BEV", "Milk", null, false, null, ["Small", "Large"], 25),
    ...
    item("cake-batter-ms", "CAKE BAT MS", "Cake Batter Milkshake", "Cake Batter MS", "BEV", "Milkshakes", null, true, "milkshakes", ["No whip", "Extra whip", "Cherry", "No cherry"], 34),
